...
export default class BiDirectionStrategy extends Strategy {
    ...
    findProfit = (token, ltp) => {
        ...
        console.log('call profit: ', this.call.profit, ' put profit: ', this.put.profit)
